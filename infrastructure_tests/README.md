...
These tests protect retained legacy ingestion and the deployed daily-summary
function. They are not part of the dissertation's scientific test surface and
are therefore excluded from the default `pytest` run.
