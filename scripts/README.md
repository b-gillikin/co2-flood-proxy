...
| `35_audit_waterschap_delivery.py` | outcome-blind coverage audit of the delivered 2010–2025 discharge table | implemented; metadata and cohort decisions remain open |
