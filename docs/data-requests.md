...
| core | gauge QA | numerical coordinates, rating eras, sampling semantics, timezone, units, zero semantics and July 2021 status | incomplete; follow-up sent 2026-09-17. Rating eras transcribed from the sheets (D8). **New question (2026-09-18):** was each part of the delivered discharge computed with the rating version in force at the time, or was history recomputed with a later relation? |
